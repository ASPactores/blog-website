...
def blacklist_token(access_token: str, refresh_token: str):
    ...
    redis_client.set(access_token_key, "blacklisted", ex=60 * 60 * 24) # 24 hours expiration time
    redis_client.set(refresh_token_key, "blacklisted", ex=60 * 60 * 24 * 7) # 7 days expiration time
    return True